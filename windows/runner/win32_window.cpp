...
// see https://github.com/flutter/flutter/issues/86244 lol
bool Win32Window::Create(const std::wstring& title,const Point& origin,const Size& size)
{
        ...
        HWND window=CreateWindow(
                ...
                static_cast<int>((GetSystemMetrics(SM_CXSCREEN)/2)-Scale(size.width/2,scale_factor)),static_cast<int>((GetSystemMetrics(SM_CYSCREEN)/2)-Scale(size.height/2,scale_factor)),
...
{
        quit_on_close_=quit_on_close; // reminder: this might be need to be changed in the future
}
